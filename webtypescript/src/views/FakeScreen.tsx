...
const FakeScreen = ({id}) => {
    ...
    useEffect(() => {
        ...
        .then(data => {console.log(data); setData(data); setSlideOption(data);        
        });
    }, [])
    ...
    const setSlideOption = (slide) => {
        if(slide.option == 1){
            ...
            setFirstStr(slide.backgroundText.slice(0, slide.backgroundText.length /3));
            setSecStr(slide.backgroundText.slice(slide.backgroundText.length /3, slide.backgroundText.length -1 ))
        }
    }
